wildboottestjlr_setup <- function (install_julia = FALSE, install_wildboottests = TRUE, julia_path){

  #' Connect R and Julia via JuliaConnectoR & installs Julia dependency packages (if required)
  #' @param install_julia Logical. True by FALSE Should Julia be installed?
