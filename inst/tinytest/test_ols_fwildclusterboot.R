...
if(run){
  ...
  boot_jl1 <- wildboottestjlr::boottest(lm_fit, clustid = "group_id1", B = 299999, param = "treatment", type = type, p_val_type = "two-tailed", rng = 1)
  boot_jl2 <- wildboottestjlr::boottest(lm_fit, clustid = "group_id1", B = 299999, param = "treatment", type = type, p_val_type = "two-tailed", rng = 1)
  boot_jl3 <- wildboottestjlr::boottest(lm_fit, clustid = "group_id1", B = 299999, param = "treatment", type = type, p_val_type = "two-tailed", rng = 2)
