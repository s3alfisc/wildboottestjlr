...
Note: currently, only a method for `lm` is implemented. The lm method only works for simple cases (the boottest & fwildclusterboot defaults). Further, the data objects are not
sorted, so all inference will be incorrect. 
