...
`WildBootTests.jl` can then be installed via 
Julia's package management system. 

To install `WildBootTests.jl` and Julia from within R, you can use functionality from [JuliaCall](https://github.com/Non-Contradiction/JuliaCall):
